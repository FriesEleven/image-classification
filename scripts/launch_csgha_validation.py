"""Validate and launch the validation-only CSGHA candidate experiment."""
...
PID_PATH = ROOT / "artifacts/csgha_validation_launcher.pid"
...
def main() -> int:
    ...
    if active_pid is not None:
        raise RuntimeError(f"CSGHA validation is already running with PID {active_pid}")
    ...
    log_path = LOG_DIRECTORY / f"csgha_validation_{timestamp}.log"
    ...
    print(f"CSGHA validation started with PID {process.pid}")
